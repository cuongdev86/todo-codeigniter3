<div class="row justify-content-center">
    <div class="col-12">
        <div class="page-title-container">
            <h2 class="mb-2 page-title">User create</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="username" id="inputUn" class="form-control" required>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <label for="inputPass" class="label-required">Password</label>
